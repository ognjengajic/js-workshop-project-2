...
const account1 = {
  ...
  movementsDates: [
    ...
    '2026-04-14T17:01:17.194Z',
    '2026-04-15T23:36:17.929Z',
    '2026-04-16T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'en-GB',
};
...
const account2 = {
  ...
  movementsDates: [
    ...
    '2026-11-05T16:33:06.386Z',
    '2026-04-14T14:43:26.374Z',
    '2026-04-15T18:49:59.371Z',
    '2026-04-16T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
*/
  ...
  combinedMovsDates.forEach(function (obj, i) {
    ...
    const formatedMov = formatCur(movement, acc.currency, acc.locale);
...
console.log(Number.parseInt(`es30px`, 10));
...
console.log(Math.max(23, 52, 26, 12, 15, `244`));
console.log(Math.max(23, 52, 26, 12, 15, `244px`));
...
console.log(new Date(`Apr 15 2026 17:13:50`));
console.log(new Date(`December 15, 2015`));

console.log(new Date(account1.movementsDates[0]));
console.log(new Date(2035, 10, 12, 15, 23, 3));
console.log(new Date(2035, 10, 31));

console.log(new Date(0));
console.log(new Date(3 * 24 * 60 * 60 * 1000));

//working with dates
const future = new Date(2052, 10, 10, 13);
console.log(future);
...
const dateNew = future.getTime();
console.log(new Date(dateNew));
console.log(new Date(2614852800000));
...
*/
/*
const future = new Date(2038, 11, 10, 12, 25);
console.log(+future);
